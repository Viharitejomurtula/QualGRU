...
print("MAX_LENGTH:", int(lengths[0]))

print("SLOT_BUDGET:", SLOT_BUDGET)
...
def get_batch_end(i):
    ...
    # Don't mix radically different read lengths in one

    # synchronous batch.  This especially isolates the 733 kb tail.
...
while i < N:
    ...
    # T-major layout makes each timestep contiguous.
