...
int main() {
    ...
    QualGRU model("export_lossy4_h32", 4, 32, 32, 8);



    std::ifstream vocab_file("qual_vocab_lossy4.txt");
    ...
    std::vector<ReadPair> reads = load_paired_file("data/paired_chr20_10k_bin4.txt");
    ...
    std::vector<int> batch_sizes = {512, 1024, 2048};



    std::cout << "=== H32 BATCH SIZE SWEEP (64 threads) ===" << std::endl;
